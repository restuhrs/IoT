...
<body>
        ...
        <div class="card animate__animated animate__fadeIn animate__delay-1s">
            <div class="card-header">
                ...
                <div class="card-actions">
                    <a href="{{ route('graph.export') }}" class="btn btn-outline">
    ...
    <div id="chartData"
        ...
        data-nilai1="{{ json_encode($dataNilai1) }}"
        data-nilai2="{{ json_encode($dataNilai2) }}">
    </div>
    ...
    <script>
        ...
        const dataNilai1 = JSON.parse(chartData.dataset.nilai1);
        const dataNilai2 = JSON.parse(chartData.dataset.nilai2);
